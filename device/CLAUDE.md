...
**One-time setup:**
```bash
# GoTinyAlsa is a git submodule at the repo root, pinned to upstream
# Binozo/GoTinyAlsa v1.0.4. It includes the GetAudioStream defer-in-loop
# leak fix previously carried by the wilbowes fork (upstream PR #1).
