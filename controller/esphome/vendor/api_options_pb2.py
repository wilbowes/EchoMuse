...
# -*- coding: utf-8 -*-
#
# VENDORED from aioesphomeapi==45.3.1 — see api_pb2.py in this directory
# for full provenance/rationale notes. Companion file to api_pb2.py,
# defines the protobuf field/message option extensions (id, source, etc)
# that api_pb2.py's messages use to declare their wire-protocol message IDs.
#
